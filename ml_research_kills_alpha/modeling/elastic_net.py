...
class ElasticNetModel(Modeler):
    """Elastic Net regression model (ENET) for return prediction:contentReference[oaicite:0]{index=0}."""
    ...
    def train(self, X_train, y_train, X_val=None, y_val=None):
        # If hyperparameters not specified, perform a grid search (2-fold CV) to find them:contentReference[oaicite:1]{index=1}
